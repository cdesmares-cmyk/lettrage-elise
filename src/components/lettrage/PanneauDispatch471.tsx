  ...
  return (
    <div className="bg-white border border-orange-100 rounded-xl shadow-sm overflow-hidden sticky top-20">
      ...
      <div className="px-5 py-4 border-b border-orange-100" style={{ background: 'linear-gradient(135deg, #FFF7ED 0%, #fff 60%)' }}>
        <p className="text-[10px] font-bold text-orange-500 uppercase tracking-widest mb-2">Compte Attente 471</p>
      ...
      {/* Date de lettrage — pré-remplie avec la date du virement, modifiable */}
      <div className="px-5 pt-4 pb-2">
        ...
        <input
          ...
          className="border border-gray-200 rounded-lg px-3 py-1.5 text-xs text-gray-700 outline-none focus:border-orange-400 bg-white"
        />
      </div>
