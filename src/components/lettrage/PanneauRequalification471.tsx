              ...
              <div className="flex items-center gap-2 mb-1.5">
                <div className="relative flex-1">
                  <select
                    ...
                    className="w-full border border-gray-200 rounded-md pl-3 pr-6 py-1.5 text-xs text-gray-700 bg-white outline-none focus:border-violet-400 appearance-none cursor-pointer"
                  >
