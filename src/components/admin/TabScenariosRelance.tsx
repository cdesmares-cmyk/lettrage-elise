// Onglet Scénarios — CRUD scénarios de relance (extrait de ModalScenariosRelance)
...
export function TabScenariosRelance() {
  ...
  function insererBaliseObjet(balise: string) {
            ...
            <div className="flex items-center justify-between mb-1.5">
              ...
              <div className="flex gap-1">
                {BALISES.filter(b => b !== '[Tableau Factures]').map(b => (
                  <button key={b} onClick={() => insererBaliseObjet(b)}
