-- Migration 119 : note interne libre sur les clients
ALTER TABLE clients ADD COLUMN IF NOT EXISTS note_client text;

-- Mise à jour de v_comptes_clients pour exposer note_client
...
GROUP BY
  ...
  c.relance_auto_alerte, c.note_client;
