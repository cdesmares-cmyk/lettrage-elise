-- Migration 120 : flag "À Suivre" partagé sur les clients
ALTER TABLE clients ADD COLUMN IF NOT EXISTS a_suivre boolean NOT NULL DEFAULT false;

-- Mise à jour de v_comptes_clients pour exposer a_suivre
